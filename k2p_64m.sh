...
sed -i 's/<0xa0000 0xf60000>/<0xa0000 0x3f40000>/g' target/linux/ramips/dts/mt7621_phicomm_k2p.dts
sed -i 's/"Phicomm K2P";/"Phicomm K2P (64M)";/g' target/linux/ramips/dts/mt7621_phicomm_k2p.dts
sed -i 's/15744k/62000k/g' target/linux/ramips/image/mt7621.mk
